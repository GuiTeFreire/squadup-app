...
| 8 | Reescrever `AuthContext` por dentro (register→login em sequência, token no storage seguro, refresh automático em 401, boot via `GET /users/me`) | 13.4 | 🟢 (`feat/auth-real`, sessão 23) |
...
**Concluídas:** 77 (69 do protótipo + refinamento visual transversal + itens 1–8 da Fase 13, sessões 20–23)
**Em andamento:** 0
**A fazer:** 9 (Fase 12: 12.3 requer dispositivo/emulador do usuário, 12.8 build de apresentação; Fase 13: itens 9–16)
