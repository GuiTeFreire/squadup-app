...
> atualizado). Sub-fases 13.1–13.6 **concluídas** (sessões 20–25) — detalhe tarefa-a-tarefa
...
**Concluídas:** 82 (69 do protótipo + refinamento visual transversal + itens 1–13 da Fase 13, sessões 20–25)
**Em andamento:** 0
**A fazer:** 4 (Fase 12: 12.3 requer dispositivo/emulador do usuário, 12.8 build de apresentação; Fase 13: itens 14–16)
