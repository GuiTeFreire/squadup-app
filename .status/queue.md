...
> atualizado). Sub-fases 13.1–13.5 **concluídas** (sessões 20–24) — detalhe tarefa-a-tarefa
...
**Concluídas:** 81 (69 do protótipo + refinamento visual transversal + itens 1–12 da Fase 13, sessões 20–24)
**Em andamento:** 0
**A fazer:** 5 (Fase 12: 12.3 requer dispositivo/emulador do usuário, 12.8 build de apresentação; Fase 13: itens 13–16)
